...
cd ./scripts_backup && curl -O "https://cdn.jsdelivr.net/npm/@mediapipe/camera_utils@0.1/camera_utils.js"
curl -O "https://cdn.jsdelivr.net/npm/@mediapipe/control_utils@0.1/control_utils.js"
